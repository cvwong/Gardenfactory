...
#Remove Outlook Data
rm -rf /User/$loggedinuser/Library/Group\ Containers/UBF8T346G9.MS /tmp/$loggedinuser/outlook2016bkup/UBF8T346G9.MS
rm -rf /User/$loggedinuser/Library/Group\ Containers/UBF8T345G9.Office /tmp/$loggedinuser/outlook2016bkup/UBF8T345G9.Office
rm -rf /User/$loggedinuser/Library/Group\ Containers/UBF8T346G9.OfficeOsfWebHost /tmp/$loggedinuser/outlook2016bkup/UBF8T346G9.OfficeOsfWebHost
echo "Outlook Data Removed"
