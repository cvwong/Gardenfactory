...
/usr/bin/defaults write /Library/Preferences/ManagedInstalls SoftwareRepoURL -string "http://app.gardenschool.edu.my/munki_repo/"
...
/usr/bin/defaults write /Library/Preferences/ManagedInstalls ClientResourceURL -string "http://app.gardenschool.edu.my/munki_repo/client_resources"
